...
def plot_training_history(history, dataset_name):
    ...
    plt.tight_layout()
    save_path = os.path.join(RESULTS_DIR, f'protbert_multilabel_{dataset_name.lower()}_training2.png')
...
if __name__ == "__main__":
    ...
    dbamp_model_path = os.path.join(RESULTS_DIR, 'protbert_multilabel_dbamp_final2.pth')
    ...
    dramp_model_path = os.path.join(RESULTS_DIR, 'protbert_multilabel_dramp_final2.pth')
    ...
    results_path = os.path.join(RESULTS_DIR, 'results_protbert_multilabel2.csv')
    ...
    plt.tight_layout()
    comparison_path = os.path.join(RESULTS_DIR, 'protbert_multilabel_comparison2.png')
