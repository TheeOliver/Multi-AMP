...
def plot_training_history(history, dataset_name):
    ...
    plt.tight_layout()
    save_path = os.path.join(RESULTS_DIR, f'prott5_multilabel_{dataset_name.lower()}_training2.png')
...
if __name__ == "__main__":
    ...
    dbamp_model_path = os.path.join(RESULTS_DIR, 'prott5_multilabel_dbamp_final2.pth')
    ...
    dramp_model, dramp_history, dramp_results = train_prott5_multilabel(
        ...
        dataset_name="DRAMP",
        model_name="Rostlab/prot_t5_xl_half_uniref50-enc",
        batch_size=8,           # unfrozen needs more memory
        epochs=10,
        learning_rate=1e-5,
        weight_decay=0.05,
    ...
    dramp_model_path = os.path.join(RESULTS_DIR, 'prott5_multilabel_dramp_final2.pth')
    ...
    results_path = os.path.join(RESULTS_DIR, 'results_prott5_multilabel2.csv')
    ...
    plt.tight_layout()
    comparison_path = os.path.join(RESULTS_DIR, 'prott5_multilabel_comparison2.png')
